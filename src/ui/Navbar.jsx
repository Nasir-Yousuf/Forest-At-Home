...
//       <div
//         className={`md:hidden absolute top-full left-0 w-full bg-[#f4f7f5]/95 backdrop-blur-xl border-b border-[#1a3c28]/10 transition-all duration-300 overflow-hidden pointer-events-auto ${isMobileMenuOpen ? "max-h-60 opacity-100 py-6" : "max-h-0 opacity-0 py-0"}`}
//       >
//         <div className="flex flex-col items-center space-y-6 text-sm font-bold tracking-widest uppercase">
//           <Link
//             to="/"
...
//           <Link
//             to="/login"
//             className="flex items-center gap-2 text-[#1a3c28]/70"
//           >
